      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-lg w-full transform transition-all hover:scale-105">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold shadow-md hover:bg-blue-700 hover:shadow-lg transition duration-300 transform hover:-translate-y-1"
          >
            Reach Truck Checklist
          </button>
        </div>
      </div>
    </div>
